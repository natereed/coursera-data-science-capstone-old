...
The corpus contains many unusual characters, such as "control" characters, Latin characters, emoji's, etc. We will remove every character that is not an English character, whitespace or punctuation:

```{r}
combined_doc <- gsub('[^[:punct:][:alnum:][\\s]]', '', combined_doc)
```
